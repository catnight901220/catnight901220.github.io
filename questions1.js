const questions1 = {
  ...
  listening: [
    {
      ...
      audioText: "As we move forward with the acquisition of Stellar Technologies, we need to exercise caution regarding information disclosure. The confidentiality agreements are still binding, and any premature announcements could adversely impact share prices in both companies. Let's maintain discretion until the legal team confirms all regulatory approvals have been secured.",
      speaker: "male",
      options: [
  ...
  grammar: [
    {
      id: 1,
      question: "Choose the correct option to complete the sentence: 'Not until the company implemented the new security protocols ____ the frequency of cyber attacks.'",
      options: [
    ...
    {
      id: 3,
      question: "Complete the sentence with the correct form: 'Had the marketing team ____ the demographic data more carefully, they would have developed a more effective campaign.'",
      options: [
        "analyze",
        "analyzed",
        "analyzing",
    ...
    {
      id: 4,
      question: "Choose the correct option: 'The financial implications of the merger are far more complex than ____ by the initial analysis.'",
      options: [
        "suggested",
        "suggesting",
        "suggest",
